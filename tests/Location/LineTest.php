...
class LineTest extends TestCase
{
    ...
    {
        $point1 = new Point(52.5, 13.5);
        $point2 = new Point(64.1, -21.9);
    ...
    public function testIfGetBoundsWorksAsExpected(): void
    {
        ...
        $point2 = new Point(3.0, 10.0);

        $line = new Line($point2, $point1);

        $expected = new Bounds(new Point(3.0, 10.0), new Point(-10.0, 20.0));
    ...
    {
        $line = new Line(new Point(0, 0), new Point(10, 20));
        ...
        $line = new Line(new Point(35, -90), new Point(35.2, -90.4));
    ...
    {
        $line = new Line(new Point(0.0, -179.0), new Point(0.0, 179.0));
        $this->assertEquals(new Point(0.0, -180.0), $line->getMidpoint());

        $line = new Line(new Point(0.0, -178.0), new Point(0.0, 179.0));
        $this->assertEquals(new Point(0.0, -179.5), $line->getMidpoint());
    }

    public function testIfGetIntermediatePointWorksAsExpected()
    {
        $line = new Line(new Point(0, 0), new Point(0, 1));
        $this->assertEquals(new Point(0, 0), $line->getIntermediatePoint(0.));
        $line = new Line(new Point(0, 0), new Point(0, 1));
        $this->assertEquals(new Point(0, .5), $line->getIntermediatePoint(.5));
        $line = new Line(new Point(0, 0), new Point(0, 1));
        $this->assertEquals(new Point(0, 1), $line->getIntermediatePoint(1.));
    }
    ...
    public function testIfGetIntermediatePointThrowsExceptionForAntipodes()
    {
        ...
        $line = new Line(new Point(45, -45), new Point(-45, 135));
