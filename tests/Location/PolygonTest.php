...
class PolygonTest extends TestCase
{
    ...
    public function testIfGetSegmentsWorksAsExpected(): void
    {
        ...
        $point2 = new Point(10, 40);
        $point3 = new Point(30, 40);
        $point4 = new Point(30, 20);
        $polygon->addPoint($point1);
        $polygon->addPoint($point2);
    ...
    public function testIfGetLatsWorksAsExpected(): void
    {
        $polygon = new Polygon();
        $polygon->addPoint(new Point(10, 20));
        $polygon->addPoint(new Point(10, 40));
    ...
    {
        $polygon = new Polygon();
        $polygon->addPoint(new Point(10, 150));
        $polygon->addPoint(new Point(10, -150));
        $polygon->addPoint(new Point(30, -150));
        $polygon->addPoint(new Point(30, 150));

        $point = new Point(20, 160);
        $this->assertTrue($polygon->contains($point));
    ...
    */
    ...
    public function testIfPerimeterCalculationWorksAsExpected(): void
    {
        ...
        $polygon = new Polygon();
        $polygon->addPoint(new Point(52, 13));
        $polygon->addPoint(new Point(53, 13));
        $polygon->addPoint(new Point(53, 12));
        $polygon->addPoint(new Point(52, 12));
    ...
    {
        $polygon = new Polygon();
        $polygon->addPoint(new Point(52.221651719883084, 13.661613101139665));
        $polygon->addPoint(new Point(52.215716242790222, 13.662988655269146));
        $polygon->addPoint(new Point(52.211922844871879, 13.662990247830749));
        $polygon->addPoint(new Point(52.208002796396613, 13.664533020928502));
        $polygon->addPoint(new Point(52.203469779342413, 13.664621533825994));
        $polygon->addPoint(new Point(52.199896154925227, 13.665583860129118));
        $polygon->addPoint(new Point(52.199177406728268, 13.665664242580533));
        $polygon->addPoint(new Point(52.197426510974765, 13.664221465587616));
        $polygon->addPoint(new Point(52.196468207985163, 13.674150248989463));
        $polygon->addPoint(new Point(52.200047867372632, 13.674412602558732));
        $polygon->addPoint(new Point(52.203508755192161, 13.676183195784688));
        $polygon->addPoint(new Point(52.206863863393664, 13.678688379004598));
        $polygon->addPoint(new Point(52.213457236066461, 13.67043505422771));
        $polygon->addPoint(new Point(52.217430174350739, 13.66775787435472));
        $polygon->addPoint(new Point(52.221683654934168, 13.661622740328312));

        $insidePolygon = new Polygon();
        $insidePolygon->addPoint(new Point(52.206110581755638, 13.674710914492607));
        $insidePolygon->addPoint(new Point(52.202216433361173, 13.673997698351741));
        $insidePolygon->addPoint(new Point(52.20279042609036, 13.666518358513713));
        $insidePolygon->addPoint(new Point(52.209159163758159, 13.667042898014188));
        $insidePolygon->addPoint(new Point(52.215381134301424, 13.664670567959547));
        $insidePolygon->addPoint(new Point(52.209875900298357, 13.672981224954128));
    ...
    public function testIfPolygonContainsGeometryWithPolygonInsideAndOutsideWorksAsExpected(): void
    {
        ...
        $inAndOutSidePolygon->addPoint(new Point(52.206110581755638, 13.674710914492607));
        $inAndOutSidePolygon->addPoint(new Point(52.202216433361173, 13.673997698351741));
        $inAndOutSidePolygon->addPoint(new Point(52.20279042609036, 13.666518358513713));
        $inAndOutSidePolygon->addPoint(new Point(52.209159163758159, 13.667042898014188));
        $inAndOutSidePolygon->addPoint(new Point(52.215381134301424, 13.664670567959547));
        $inAndOutSidePolygon->addPoint(new Point(52.209875900298357, 13.672981224954128));
        $inAndOutSidePolygon->addPoint(new Point(52.211303086951375, 13.676270367577672));
        $inAndOutSidePolygon->addPoint(new Point(52.20556978136301, 13.688599476590753));
        $inAndOutSidePolygon->addPoint(new Point(52.205583276227117, 13.688599476590753));
        $inAndOutSidePolygon->addPoint(new Point(52.204232113435864, 13.683774350211024));
    ...
    public function testIfPolygonContainsGeometryWithPolygonOutsideWorksAsExpected(): void
    {
        ...
        $outsidePolygon->addPoint(new Point(52.2123983502388, 13.677485324442387));
        $outsidePolygon->addPoint(new Point(52.215186841785908, 13.683912232518196));
        $outsidePolygon->addPoint(new Point(52.207024795934558, 13.685344364494085));
    ...
    public function testIfPolygonContainsGeometryWithPolylineInsideWorksAsExpected(): void
    {
        ...
        $insidePolyline->addPoint(new Point(52.206110581755638, 13.674710914492607));
        $insidePolyline->addPoint(new Point(52.202216433361173, 13.673997698351741));
        $insidePolyline->addPoint(new Point(52.20279042609036, 13.666518358513713));
        $insidePolyline->addPoint(new Point(52.209159163758159, 13.667042898014188));
        $insidePolyline->addPoint(new Point(52.215381134301424, 13.664670567959547));
        $insidePolyline->addPoint(new Point(52.209875900298357, 13.672981224954128));
    ...
    public function testIfPolygonContainsGeometryWithPolylineInsideAndOutsideWorksAsExpected(): void
    {
        ...
        $inAndOutSidePolyline->addPoint(new Point(52.206110581755638, 13.674710914492607));
        $inAndOutSidePolyline->addPoint(new Point(52.202216433361173, 13.673997698351741));
        $inAndOutSidePolyline->addPoint(new Point(52.20279042609036, 13.666518358513713));
        $inAndOutSidePolyline->addPoint(new Point(52.209159163758159, 13.667042898014188));
        $inAndOutSidePolyline->addPoint(new Point(52.215381134301424, 13.664670567959547));
        $inAndOutSidePolyline->addPoint(new Point(52.209875900298357, 13.672981224954128));
        $inAndOutSidePolyline->addPoint(new Point(52.211303086951375, 13.676270367577672));
        $inAndOutSidePolyline->addPoint(new Point(52.20556978136301, 13.688599476590753));
        $inAndOutSidePolyline->addPoint(new Point(52.205583276227117, 13.688599476590753));
        $inAndOutSidePolyline->addPoint(new Point(52.204232113435864, 13.683774350211024));
    ...
    public function testIfPolygonContainsGeometryWithPolylineOutsideWorksAsExpected(): void
    {
        ...
        $outsidePolyline->addPoint(new Point(52.2123983502388, 13.677485324442387));
        $outsidePolyline->addPoint(new Point(52.215186841785908, 13.683912232518196));
        $outsidePolyline->addPoint(new Point(52.207024795934558, 13.685344364494085));
    ...
    public function testIfPolygonContainsGeometryWithLineInsideWorksAsExpected(): void
    {
        ...
        $insideLine = new Line(
            new Point(52.206110581755638, 13.674710914492607),
            new Point(52.202216433361173, 13.673997698351741)
        );
    ...
    public function testIfPolygonContainsGeometryWithLineInsideAndOutsideWorksAsExpected(): void
    {
        ...
        $inAndOutSidePolyline = new Line(
            new Point(52.207389576360583, 13.670525830239058),
            new Point(52.210680730640888, 13.687128368765116)
        );
    ...
    public function testIfPolygonContainsGeometryWithLineOutsideWorksAsExpected(): void
    {
        ...
        $outsidePolyline = new Line(
            new Point(52.215186841785908, 13.683912232518196),
            new Point(52.207024795934558, 13.685344364494085)
        );
    ...
    public function testIfPolygonContainsGeometryWithPointInsideWorksAsExpected(): void
    {
        ...
        $this->assertTrue($polygon->containsGeometry(new Point(52.206110581755638, 13.674710914492607)));
    }
    ...
    public function testIfPolygonContainsGeometryWithPointOutsideWorksAsExpected(): void
    {
        ...
        $this->assertFalse($polygon->containsGeometry(new Point(52.2123983502388, 13.677485324442387)));
    }
    ...
    public function testIfGetBoundsWorksAsExpected(): void
    {
        ...
        $point2 = new Point(-10.0, 40.0);
        $point3 = new Point(30.0, 50.0);
        $point4 = new Point(40.0, 20.0);
        $polygon->addPoint($point1);
        $polygon->addPoint($point2);
        $polygon->addPoint($point3);
        $polygon->addPoint($point4);

        $expected = new Bounds(new Point(40.0, -20.0), new Point(-10.0, 50.0));
